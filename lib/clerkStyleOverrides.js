...
export function applyUserProfileStyles(modalRootElement) {
    ...
    if (document.documentElement.classList.contains('dark-mode')) {
        explicitTextColor = '#f0f0f0'; // Directly use the hex for --text-color-dark
    ...
    console.log('[JS Override] applyUserProfileStyles called. Determined explicitTextColor:', explicitTextColor);
